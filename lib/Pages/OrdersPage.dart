        ...
        child: Column(children: [
          Container(width: 336,
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  Text("Order #1514", style: TextStyle(
                      fontSize: 18, fontWeight: FontWeight.bold),),
                  Spacer(),
                  Text("13/05/2021", style: TextStyle(fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Color(0xFFF777E90
                      )),),
                ],),
                SizedBox(height: 20,),
                ...
                Row(children: [
                  Text("Quantity: 2", style: TextStyle(
                      fontSize: 18, fontWeight: FontWeight.bold),),
                  Spacer(),
                  Text("Subtotal: 110", style: TextStyle(fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Color(0xFFF777E90
                      )),),
                ],),
                ...
                Row(children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: Text(
                          "Details", style: TextStyle(), textAlign: TextAlign
                            .center,)
                    ),
                  )
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  Text("Order #1679", style: TextStyle(
                      fontSize: 18, fontWeight: FontWeight.bold),),
                  Spacer(),
                  Text("13/05/2021", style: TextStyle(fontSize: 18,
                      fontWeight: FontWeight.bold,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  Text("Order #1671", style: TextStyle(
                      fontSize: 18, fontWeight: FontWeight.bold),),
                  Spacer(),
                  Text("13/05/2021", style: TextStyle(fontSize: 18,
                      fontWeight: FontWeight.bold,
